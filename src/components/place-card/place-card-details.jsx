...
const PlaceCardDetails = (props) => {
  const {place} = props;
  const {name, amount, amountDescription, rating, type, isPremium, isInBookmark, description, image} = place;
  const {photos, features, insideItems} = place;
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              ...
              <div className="property__price">
                <b className="property__price-value">&euro;{amount}</b>
                <span className="property__price-text">&nbsp;{amountDescription}</span>
              </div>
